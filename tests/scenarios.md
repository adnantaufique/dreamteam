...
> S1–S25 are re-run as regression — S26–S39 are additive (they verify the Phase A–H bundle build). S37 is the dedicated check for the `project_key` + numeric-confidence learnings schema that S8/S9/S22 also rely on.
